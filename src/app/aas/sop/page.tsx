...
export default function AASSOPPage() {
  const handleDownload = () => {
    const link = document.createElement('a');
    link.href = '/AAS-Machine-SOP.pdf';
    link.download = 'AAS-Machine-SOP.pdf';
          ...
          >
            ...
            >
              ...
              <p className="text-[#374151] text-sm sm:text-base lg:text-lg leading-relaxed max-w-xl mx-auto">
                The Standard Operation Procedure for AAS Machine gives the complete guide step by step on how to power and set the AAS machine to use. This helps student to understand the proper procedures to follow in turning on and getting the AAS machine for action.
              </p>
            </motion.div>
