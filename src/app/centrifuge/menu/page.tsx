...
const menuItems = [
  { title: 'Definition of Centrifuge Machine', href: '/centrifuge/overview', icon: BookOpen },
  { title: 'Parts/Component of Centrifuge Machine', href: '/centrifuge/parts', icon: Layers },
  { title: 'Types of Centrifuge Machine', href: '/centrifuge/types', icon: FlaskConical },
...
const menuImages = [
  { src: '/images/scientist-aas.png', alt: 'Scientist using lab equipment' },
  { src: '/images/scientists-group.png', alt: 'Group of scientists in laboratory' },
];

export default function CentrifugeMenuPage() {
  return (
        ...
        <div className="px-5 sm:px-8 pt-4 pb-6 text-center">
          ...
          >
            ...
            <h1 className="text-[#1a237e] text-2xl sm:text-3xl font-bold tracking-tight">
              Centrifuge Machine Study Module
            </h1>
